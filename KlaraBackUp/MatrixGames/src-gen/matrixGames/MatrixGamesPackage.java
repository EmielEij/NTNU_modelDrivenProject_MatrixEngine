...
public interface MatrixGamesPackage extends EPackage {
	...
	/**
	 * Returns the meta object for the containment reference '{@link matrixGames.Rule#getLogic <em>Logic</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference '<em>Logic</em>'.
	 * @see matrixGames.Rule#getLogic()
	 * @see #getRule()
	 * @generated
	 */
	EReference getRule_Logic();
	...
	interface Literals {
		 ...
		 * @generated
		 */
		EReference RULE__LOGIC = eINSTANCE.getRule_Logic();
