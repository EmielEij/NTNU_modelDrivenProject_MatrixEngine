...
class Connect4Logic
{
	...
	public static void main(String[] args) {
	    ...
	    Connect4Player player1 = new Connect4Player(player1Name, player1Symbol);
	    Connect4Player player2 = new Connect4Player(player2Name, player2Symbol);
	
	    Connect4Logic game = new Connect4Logic(player1, player2);
	    game.startGame();
	  }
