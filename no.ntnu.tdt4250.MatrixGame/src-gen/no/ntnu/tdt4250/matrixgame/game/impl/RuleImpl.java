 ...
 * </p>
 * <ul>
 *   <li>{@link no.ntnu.tdt4250.matrixgame.game.impl.RuleImpl#getRows <em>Rows</em>}</li>
 *   <li>{@link no.ntnu.tdt4250.matrixgame.game.impl.RuleImpl#getColumns <em>Columns</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RuleImpl extends MinimalEObjectImpl.Container implements Rule {
	...
	public void setRows(int newRows) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GamePackage.RULE__ROWS, oldRows, rows));
	}
	...
	public void setColumns(int newColumns) {
		...
		columns = newColumns;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GamePackage.RULE__COLUMNS, oldColumns, columns));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case GamePackage.RULE__ROWS:
			return getRows();
		case GamePackage.RULE__COLUMNS:
			return getColumns();
		}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
		case GamePackage.RULE___CHECK_WINNER:
			return checkWinner();
		case GamePackage.RULE___IS_BOARD_FULL:
			return isBoardFull();
		}
