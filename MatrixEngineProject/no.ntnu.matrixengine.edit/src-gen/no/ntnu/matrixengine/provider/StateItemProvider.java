...
/**
 * This is the item provider adapter for a {@link no.ntnu.matrixengine.State} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
	...
	protected void addMapPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_State_map_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_State_map_feature", "_UI_State_type"),
						MatrixenginePackage.Literals.STATE__MAP, true, false, true, null, null, null));
	}
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_State_turnsTaken_feature",
								"_UI_State_type"),
						MatrixenginePackage.Literals.STATE__TURNS_TAKEN, true, false, false,
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_State_flagsPlaced_feature",
								"_UI_State_type"),
						MatrixenginePackage.Literals.STATE__FLAGS_PLACED, true, false, false,
						ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE, null, null));
	}
	...
	protected void addIsOverPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						MatrixenginePackage.Literals.STATE__IS_OVER, true, false, false,
