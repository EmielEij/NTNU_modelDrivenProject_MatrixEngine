...
/**
 * This is the item provider adapter for a {@link no.ntnu.matrixengine.Map} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MapItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						MatrixenginePackage.Literals.MAP__NAME, true, false, false,
	...
	protected void addTilePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Map_tile_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Map_tile_feature", "_UI_Map_type"),
						MatrixenginePackage.Literals.MAP__TILE, false, false, false, null, null, null));
	}
	...
	protected void addSizeYPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Map_SizeY_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Map_SizeY_feature", "_UI_Map_type"),
						MatrixenginePackage.Literals.MAP__SIZE_Y, true, false, false,
	...
	protected void addSizeXPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Map_SizeX_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Map_SizeX_feature", "_UI_Map_type"),
						MatrixenginePackage.Literals.MAP__SIZE_X, true, false, false,
						ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE, null, null));
	}
