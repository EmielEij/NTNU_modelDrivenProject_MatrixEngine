 ...
 * </p>
 * <ul>
 *   <li>{@link matrixGameEngine.impl.StateImpl#getTurnsTaken <em>Turns Taken</em>}</li>
 *   <li>{@link matrixGameEngine.impl.StateImpl#isFlagsPlaced <em>Flags Placed</em>}</li>
 *   <li>{@link matrixGameEngine.impl.StateImpl#isIsOver <em>Is Over</em>}</li>
 *   <li>{@link matrixGameEngine.impl.StateImpl#getTile <em>Tile</em>}</li>
 * </ul>
 *
 * @generated
 */
public class StateImpl extends MinimalEObjectImpl.Container implements State {
	...
	protected EClass eStaticClass() {
		return MatrixGameEnginePackage.Literals.STATE;
	}
	...
	public void setTurnsTaken(int newTurnsTaken) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MatrixGameEnginePackage.STATE__TURNS_TAKEN,
					oldTurnsTaken, turnsTaken));
	}
	...
	public void setFlagsPlaced(boolean newFlagsPlaced) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MatrixGameEnginePackage.STATE__FLAGS_PLACED,
	...
	public void setIsOver(boolean newIsOver) {
		...
		isOver = newIsOver;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MatrixGameEnginePackage.STATE__IS_OVER, oldIsOver,
					isOver));
	}
	...
	public Tile getTile() {
		if (tile != null && tile.eIsProxy()) {
			...
			if (tile != oldTile) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, MatrixGameEnginePackage.STATE__TILE,
							oldTile, tile));
			}
		}
		return tile;
	...
	public void setTile(Tile newTile) {
		...
		tile = newTile;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MatrixGameEnginePackage.STATE__TILE, oldTile, tile));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		...
		case MatrixGameEnginePackage.STATE__IS_OVER:
			return isIsOver();
		case MatrixGameEnginePackage.STATE__TILE:
			if (resolve)
				return getTile();
			return basicGetTile();
		}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
		case MatrixGameEnginePackage.STATE___GET_CURRENT_STATUS:
			return getCurrentStatus();
		case MatrixGameEnginePackage.STATE___GET_PLAYERS_TURN:
