...
public class MatrixGamesPackageImpl extends EPackageImpl implements MatrixGamesPackage {
	 ...
	 */
	@Override
	public EReference getRule_Logic() {
	...
	public void createPackageContents() {
		...
		createEReference(ruleEClass, RULE__LOGIC);
	...
	public void initializePackageContents() {
		...
		initEAttribute(getRule_Columns(), ecorePackage.getEInt(), "columns", null, 1, 1, Rule.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getRule_Logic(), this.getLogic(), null, "logic", null, 1, 1, Rule.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);

		initEOperation(getRule__CheckWinner(), null, "checkWinner", 0, 1, IS_UNIQUE, IS_ORDERED);

		initEOperation(getRule__IsBoardFull(), null, "isBoardFull", 0, 1, IS_UNIQUE, IS_ORDERED);
		...
		initEAttribute(getBoard_Columns(), ecorePackage.getEInt(), "columns", null, 1, 1, Board.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getBoard_BoardName(), ecorePackage.getEString(), "boardName", null, 0, 1, Board.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEOperation(getBoard__DisplayBoard(), null, "displayBoard", 0, 1, IS_UNIQUE, IS_ORDERED);

		initEOperation(getBoard__DropPiece(), null, "dropPiece", 1, 1, IS_UNIQUE, IS_ORDERED);

		initEOperation(getBoard__GetGameBoard(), null, "getGameBoard", 1, 1, IS_UNIQUE, IS_ORDERED);
		...
		initEAttribute(getPlayer_Symbol(), ecorePackage.getEChar(), "symbol", null, 0, 1, Player.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getPlayer_GamePlayer(), ecorePackage.getEString(), "GamePlayer", null, 0, 1, Player.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
