...
/**
 * This is the item provider adapter for a {@link matrixGames.Rule} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RuleItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addRowsPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Rule_rows_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Rule_rows_feature", "_UI_Rule_type"),
						MatrixGamesPackage.Literals.RULE__ROWS, true, false, false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(MatrixGamesPackage.Literals.RULE__LOGIC);
		}
	...
	public String getText(Object object) {
		Integer labelValue = ((Rule) object).getRows();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(MatrixGamesPackage.Literals.RULE__LOGIC,
				MatrixGamesFactory.eINSTANCE.createLogic()));
	}
