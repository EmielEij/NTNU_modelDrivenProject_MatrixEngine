...
/**
 * This is the item provider adapter for a {@link matrixGames.Player} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PlayerItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addGamePlayerPropertyDescriptor(object);
		}
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						MatrixGamesPackage.Literals.PLAYER__NAME, true, false, false,
	...
	protected void addSymbolPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Player_symbol_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Player_symbol_feature", "_UI_Player_type"),
						MatrixGamesPackage.Literals.PLAYER__SYMBOL, true, false, false,
						ItemPropertyDescriptor.TEXT_VALUE_IMAGE, null, null));
	}

	/**
	 * This adds a property descriptor for the Game Player feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addGamePlayerPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Player_GamePlayer_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Player_GamePlayer_feature",
								"_UI_Player_type"),
						MatrixGamesPackage.Literals.PLAYER__GAME_PLAYER, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
